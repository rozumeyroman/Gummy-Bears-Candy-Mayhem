...
<html lang="uk"><head>
  ...
  <div class="main-layout"><div class="version-card"><h3>🔄 Історія версій</h3><div>${changelogHtml}</div></div><div class="game-container"><canvas id="gameCanvas" width="1200" height="550"></canvas></div></div>
